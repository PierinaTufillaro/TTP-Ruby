...
describe '#contar' do
	...
	describe 'cuando ambos parametros son string' do
		...
		it 'Devuelve 4 porque se encuentran 4 palabras' do
			a = "pierina pierina pierina pierina tufillaro"
			b = "pierina"
			assert_equal("El total de palabras contadas es 4", contar(a,b))
		end

		it 'Devuelve 2 porque se encuentran 2 palabras' do
			a = "pierina pierinano pierina pierinasi tufillaro"
			b = "pierina"
			assert_equal("El total de palabras contadas es 2", contar(a,b))
		end
	end
end